<%@ Page Title="" Language="C#" MasterPageFile="~/Padrao.Master" AutoEventWireup="true" CodeBehind="COMCOF.aspx.cs" Inherits="PSCE.COMCOF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 width:68pt" width="90" />
        ...
        <tr height="43" style="mso-height-source:userset;height:32.25pt">
            <td class="auto-style2" colspan="8" height="43" width="670">Recepção da Tesouraria</td>
        </tr>
        ...
        <tr height="33" style="mso-height-source:userset;height:24.95pt">
            ...
            <td class="auto-style9">
                <asp:Label ID="lblRTen1" runat="server" Text="5"></asp:Label>
            </td>
            <td class="auto-style10" width="90">
                <asp:Label ID="lblRTms1" runat="server" Text="4"></asp:Label>
            </td>
            <td class="auto-style11" width="98">
                <asp:Label ID="lblRTs1" runat="server" Text="3"></asp:Label>
            </td>
            <td class="auto-style10" width="90">
                <asp:Label ID="lblRTins1" runat="server" Text="2"></asp:Label>
            </td>
            <td class="auto-style10" width="90">
                <asp:Label ID="lblRTmins1" runat="server" Text="1"></asp:Label>
            </td>
        </tr>
        <tr height="33" style="mso-height-source:userset;height:24.95pt">
            <td class="auto-style8" colspan="3" height="33" width="213">Clareza nas informações</td>
            <td class="auto-style12">
                <asp:Label ID="lblRTen2" runat="server" Text="5"></asp:Label>
            </td>
            <td class="auto-style13" width="90">
                <asp:Label ID="lblRTms2" runat="server" Text="4"></asp:Label>
            </td>
            <td class="auto-style14" width="98">
                <asp:Label ID="lblRTs2" runat="server" Text="3"></asp:Label>
            </td>
            <td class="auto-style13" width="90">
                <asp:Label ID="lblRTins2" runat="server" Text="2"></asp:Label>
            </td>
            <td class="auto-style15" width="90">
                <asp:Label ID="lblRTmins2" runat="server" Text="1"></asp:Label>
            </td>
        </tr>
        <tr height="33" style="mso-height-source:userset;height:24.95pt">
            <td class="auto-style8" colspan="3" height="33" width="213">Tempo de espera no faturamento da conta</td>
            <td class="auto-style12">
                <asp:Label ID="lblRTen3" runat="server" Text="5"></asp:Label>
            </td>
            <td class="auto-style13" width="90">
                <asp:Label ID="lblRTms3" runat="server" Text="4"></asp:Label>
            </td>
            <td class="auto-style14" width="98">
                <asp:Label ID="lblRTs3" runat="server" Text="3"></asp:Label>
            </td>
            <td class="auto-style13" width="90">
                <asp:Label ID="lblRTins3" runat="server" Text="2"></asp:Label>
            </td>
            <td class="auto-style15" width="90">
                <asp:Label ID="lblRTmins3" runat="server" Text="1"></asp:Label>
            </td>
        </tr>
        <tr height="33" style="mso-height-source:userset;height:24.95pt">
            <td class="auto-style16" colspan="3" height="76" rowspan="2" width="213">Resultado</td>
            <td class="auto-style17" colspan="2">
                <asp:Label ID="lblRTmediaS" runat="server" Text="Média"></asp:Label>
            </td>
            <td class="auto-style14" width="98">
                <asp:Label ID="lblRTmediaOM" runat="server" Text="Média"></asp:Label>
            </td>
            <td class="auto-style18" colspan="2" width="180">
                <asp:Label ID="lblRTmediaINS" runat="server" Text="Média"></asp:Label>
            </td>
        </tr>
        <tr height="43" style="mso-height-source:userset;height:32.25pt">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 ...
 collapse;width:504pt" width="670">
        ...
        <tr height="33">
            <td class="auto-style8" colspan="3" height="33" width="213">Organização</td>
            <td class="auto-style12">
