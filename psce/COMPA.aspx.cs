...
namespace PSCE
{
    public partial class COMPA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable MInsatisfeito1 = bd.lista("SELECT count(*) FROM `fpa` WHERE CRQ1 = 5 ");
            ...
            DataTable MInsatisfeito2 = bd.lista("SELECT count(*) FROM `fpa` WHERE CRQ2 = 5 ");
            ...
            DataTable MInsatisfeito3 = bd.lista("SELECT count(*) FROM `fpa` WHERE CRQ3 = 5 ");
