  ...
  <tr>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                ...
                <tr>                             
                <td colspan="6">
                <asp:RadioButton ID="Q1R1" GroupName="Q1" runat="server" />Clínica Alergologia/Pneumologia
                <asp:RadioButton ID="Q1R2" GroupName="Q1" runat="server" />Clínica Cardiologia
                <asp:RadioButton ID="Q1R3" GroupName="Q1" runat="server" />Clínica Cirurgia Pediátrica
                <asp:RadioButton ID="Q1R4" GroupName="Q1" runat="server" />Clínica Gastroenterologia <br />
                <asp:RadioButton ID="Q1R5" GroupName="Q1" runat="server" />Clínica Neurologia/Neurocirurgia 
                <asp:RadioButton ID="Q1R6" GroupName="Q1" runat="server" />Clínica Oftalmologia
                <asp:RadioButton ID="Q1R7" GroupName="Q1" runat="server" />Clínica Ortopedia
                <asp:RadioButton ID="Q1R8" GroupName="Q1" runat="server" />Clínica Otorrinolaringologia
                <asp:RadioButton ID="Q1R9" GroupName="Q1" runat="server" />Clínica Outras
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                <span style="text-align:center;font-family:'Arial Rounded MT';font-size:14px;color:rgb(90,90,90);"><b>Atendimento médico</b></span> 
            </td>
  </tr>
                <tr>
                <td>Cordialidade no atendimento</td>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                ...
                <td><asp:RadioButton ID="Q12R1" GroupName="Q12" runat="server" />Muito Insatisfeito</td>
                                ...
                                <tr>
                <td class="auto-style16">Clareza nas informações</td>
                ...
                <tr>
                <td class="auto-style16">Assistência prestada</td>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                ...
                <tr>
                <td>Organização do consultório</td>
