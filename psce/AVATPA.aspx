...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        AVALIAÇÃO DE ATENDIMENTO - PRONTO ATENDIMENTO</p>
</asp:Content>
  ...
  <tr>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                <span style="text-align:center;font-family:'Arial Rounded MT';font-size:14px;color:rgb(90,90,90);"><b>Classificação de Risco - Triagem</b></span> 
            </td>
  </tr>
                <tr>
                ...
                <tr>
                <td>Tempo de espera para o atendimento<br /> quanto a sua classificação de risco</td>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                ...
                <tr>
                <td>Tempo de espera para o atendimento<br> da recepção</td>
    ...
    <tr>
            <td  colspan="6" class="auto-style2"  style="text-align:center;background-color:rgb(219,238,243);">
                ...
                <tr>
                <td>Tempo de espera para o atendimento<br /> médico</td>
